...
public class MultiplyMatrix {
	...
	public static int[][] processMatrix4(int[][] firstMatrix) {
    	...
    	int[][] returnMatrix = new int[r1][c1];
    	...
    	try {
    		...
    		for (int y = 1 ; y < c1-1; y++){
	            for (int x = 0 ; x < r1-1; x++){
	                ...
	                Color c = new Color(firstMatrix[x][y]);
                    ...
                    Color modColor = new Color(sumR, green, blue);
                    returnMatrix[x][y] = modColor.getRGB();
	                //MyImage.eI.points[x][y].red = sumR;
	                //MyImage.eI.points[x][y].green = sumG;
	                //MyImage.eI.points[x][y].blue = sumB;
	            }
