...
public class PaillierAlgorithm {
	...
	public PaillierAlgorithm(int STRENGTH, BigInteger N, BigInteger G, 
			BigInteger R, BigInteger P, BigInteger Q, BigInteger NSquare, BigInteger MU, BigInteger LAMBDA, BigInteger C) {
